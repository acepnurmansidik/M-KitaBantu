...
Color kPrimaryColor = const Color(0xff347EFE);
Color kSecondaryColor = const Color(0xff8AB4FE);
Color kGreyColor = const Color(0xffBCBCBC);
Color kBlackColor = const Color(0xff3C3C3C);
Color kWhitekColor = const Color(0xffffffff);
